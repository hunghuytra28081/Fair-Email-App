...
public class EntityAttachment {
    ...
    public static final Integer PGP_CONTENT = 4;
    public static final Integer SMIME_MESSAGE = 5;
    public static final Integer SMIME_SIGNATURE = 6;
    public static final Integer SMIME_SIGNED_DATA = 7;
    public static final Integer SMIME_CONTENT = 8;
        ...
        for (EntityAttachment attachment : attachments) {
            ...
            if (attachment.available) {
                ...
                try {
                    ...
                    Log.e("EntityAttachment",ex.toString());
    ...
    public String getMimeType() {
        ...
        if (!TextUtils.isEmpty(type) && !type.equals(gtype))
            Log.w("EntityAttachment","Mime type=" + type + " extension=" + extension + " guessed=" + gtype);
