...
public class DnsHelper {
    ...
    @NonNull
    public static DnsRecord[] lookup(Context context, String name, String type) throws UnknownHostException {
    ...
    static DnsRecord[] lookup(Context context, String name, String type, int timeout) throws UnknownHostException {
        ...
        try {
            SimpleResolver resolver = new SimpleResolver(getDnsServer(context)) {
                ...
                public Message send(Message query) throws IOException {
                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.Q)
                        ...
                        Log.i("DnsHelper","Using Android DNS resolver");
                        ...
                        Log.i("DnsHelper","DNS query=" + query.toString());
                        resolver.rawQuery(
                                null,
                                query.toWire(),
                        ...
                        if (ex == null) {
                            ...
                            Log.i("DnsHelper","DNS answer=" + result.toString() + " flags=" + result.getHeader().printFlags());
                            return result;
                        } else {
                            Log.w("DnsHelper",ex);
                            throw ex;
            ...
            Log.i("DnsHelper","Lookup name=" + name + " @" + resolver.getAddress() + " type=" + rtype);
            ...
            if (lookup.getResult() == Lookup.HOST_NOT_FOUND ||
                ...
                Log.i("DnsHelper","DNS error=" + lookup.getErrorString());

            List<DnsRecord> result = new ArrayList<>();

            if (records != null)
                for (Record record : records) {
                    Log.i("DnsHelper","Found record=" + record);
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M)
            for (Network network : cm.getAllNetworks()) {
                ...
                if (ni != null && ni.isConnected()) {
                    ...
                    Log.i("DnsHelper","Old props=" + props);
                    break;
                }
            }
        else {
            ...
            Log.i("DnsHelper","New props=" + props);
        }
