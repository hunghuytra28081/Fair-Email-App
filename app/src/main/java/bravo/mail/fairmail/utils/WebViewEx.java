...
public class WebViewEx extends WebView implements DownloadListener, View.OnLongClickListener {
    ...
    void init(int height, int maxHeight, float size, Pair<Integer, Integer> position, boolean force_light, IWebView intf) {
        Log.i("WebViewEx","Init height=" + height + "/" + maxHeight + " size=" + size);

        if (maxHeight == 0) {
            Log.e("WebViewEx","WebView max height zero");
        ...
        setWebViewClient(new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                Log.i("WebViewEx","Started url=" + url);
            }

            @Override
            public void onPageFinished(WebView view, String url) {
                Log.i("WebViewEx","Finished url=" + url);
            }

            @Override
            public void onPageCommitVisible(WebView view, String url) {
                Log.i("WebViewEx","Commit url=" + url + " runnable=" + (onPageLoaded != null));
            ...
            public boolean onRenderProcessGone(WebView view, RenderProcessGoneDetail detail) {
                Log.e("WebViewEx","Render process gone");
                if (onPageLoaded != null) {
                    ApplicationEx.getMainHandler().post(onPageLoaded);
                    onPageLoaded = null;
                }
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                Log.i("WebViewEx","Open url=" + url);
                return intf.onOpenLink(url);
            }

            @Override
            public void onScaleChanged(WebView view, float oldScale, float newScale) {
                Log.i("WebViewEx","Changed scale=" + newScale);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
            setOnScrollChangeListener(new OnScrollChangeListener() {
                ...
                public void onScrollChange(View v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                    Log.i("WebViewEx","Scroll (x,y)=" + scrollX + "," + scrollY);
    ...
    void setOnPageLoaded(Runnable runnable) {
        Log.i("WebViewEx","Set on page finished");
        ...
        ApplicationEx.getMainHandler().postDelayed(new Runnable() {
            ...
            public void run() {
                try {
                    if (onPageLoaded != null) {
                        Log.i("WebViewEx","Page loaded fallback");
                        onPageLoaded.run();
                        onPageLoaded = null;
                    }
                } catch (Throwable ex) {
                    Log.e("WebViewEx",ex.toString());
                }
            }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.i("WebViewEx","Measured height=" + mh + " last=" + height + "/" + maxHeight + " ch=" + getContentHeight());
        if (mh == 0 && legacy)
    ...
    protected void onSizeChanged(int w, int h, int ow, int oh) {
        ...
        Log.i("WebViewEx","Size changed height=" + h);
    ...
    protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX, int scrollRangeY, int maxOverScrollX, int maxOverScrollY, boolean isTouchEvent) {
        ...
        Log.i("WebViewEx","onOverScrolled clamped=" + clampedY + " new=" + newScrollY + " dy=" + deltaY);
    ...
    public void onDownloadStart(
        ...
        Log.i("WebViewEx","Download url=" + url + " mime type=" + mimetype);
    ...
    public boolean onLongClick(View view) {
        ...
        if (result.getType() == HitTestResult.IMAGE_TYPE ||
            ...
            Log.i("WebViewEx","Long press url=" + result.getExtra());
