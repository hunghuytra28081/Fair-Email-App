...
public class EntityAccount extends EntityOrder implements Serializable {
    ...
    public static final int DEFAULT_KEEP_ALIVE_INTERVAL = 15; // minutes
    public static final int DEFAULT_POLL_INTERVAL = 15; // minutes
    public static final int DEFAULT_MAX_MESSAGES = 250; // POP3
