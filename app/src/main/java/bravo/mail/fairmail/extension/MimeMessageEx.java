...
public class MimeMessageEx extends MimeMessage {
    ...
    public MimeMessageEx(Session session, InputStream is, String msgid) throws MessagingException {
        super(session, is);
        this.msgid = msgid;
    }

    public MimeMessageEx(Session session, InputStream is, MimeMessage original) throws MessagingException {
        super(session, is);
    ...
    protected void updateMessageID() throws MessagingException {
        if (this.msgid == null)
            ...
            Log.i("MimeMessageEx","Override Message-ID=" + msgid);
        }
    }
