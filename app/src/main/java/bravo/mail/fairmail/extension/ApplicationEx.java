    ...
    static Context getLocalizedContext(Context context) {
        ...
        try {
            ...
            if (language != null) {
                ...
                Log.i("ApplicationEx","Set language=" + language + " locale=" + locale);
            ...
            StrictMode.VmPolicy policy = new StrictMode.VmPolicy.Builder(StrictMode.getVmPolicy())
                    ...
                    .penaltyListener(getMainExecutor(), new StrictMode.OnVmViolationListener() {
                        ...
                        public void onVmViolation(Violation v) {
                            ...
                            Log.e("ApplicationEx",v.getMessage());
                        }
                    })
                    .build();
...
//        CoalMine.setup(leak_canary);
        ...
        Log.i("ApplicationEx","Load emoji=" + load_emoji);
        if (!load_emoji)
            try {
        ...
        Log.i("ApplicationEx","Work manager=" + work_manager);
        if (work_manager) {
            // Legacy
            try {
        ...
        Log.i("ApplicationEx","App created " + (end - start) + " ms");
    }
